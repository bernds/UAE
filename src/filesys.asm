...
FSIN_explibok:
	...
	move.l #PP_TOTAL,d7 ; initialize it
	subq.l #4,d7
FSIN_loop:
...
MKDV_nordbfs1:
	; if negative, do not mount but we might need to load possible
	; custom filesystem(s)
	tst.l d3
	bmi.s MKDV_devremember
